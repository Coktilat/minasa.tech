...
if ( is_singular( 'tribe_events' ) ) {
    get_template_part( 'single-tribe_events' );
}
else {
    get_header();
    ...
    if ($prk_hook_options['archives_type'] == "masonry") {
        ...
        <div id="hook_ajax_inner" class="page-prk-blog-grid<?php echo esc_attr($hook_featured_style); ?>">
            <div id="hook_content">
                ...
                ?>
                <div id="hook_content_inner">
                    <div class="small-12 small-centered columns row <?php if (get_field('limit_width') == 1 || $hook_show_sidebar == true) {
                        echo "prk_inner_block";
                    } else {
                        echo "hook_unblog";
                    } ?>">
                        <?php
