		...
		<div id="footer-bottom">
			<div class="container clearfix">
				...
				<?php if ( '' !== ( $mharty_cr_notice = get_theme_mod( 'cr_notice', '' ) ) ) {
					...
					<div class="mh_cr"<?php if ( 'on' !== mh_get_option( 'mharty_show_cr', 'on')) echo ' style="display:none;"'; ?>><?php mh_wp_kses( printf( __( 'Powered by %1$s | %2$s', 'mharty' ), '<a href="https://mharty.com" title="'. esc_html__( 'Premium RTL Wordpress Theme', 'mharty' ) .'">'. esc_html__( 'Mharty', 'mharty' ) .'</a>', '<a href="https://wordpress.org">'. esc_html__( 'WordPress', 'mharty' ) .'</a>' ) );?>
					</div>
				</div>
			</div>	<!-- .container -->
		</div> <!--footer-bottom-->
