...
<?php endif; ?>
	...
	<?php endif; ?>
	<?php if ('open' == $post->comment_status) : ?>
		<?php comment_form( array('label_submit' => esc_attr__( 'Submit', 'mharty' ), 'title_reply' => '<span>' . esc_attr__( 'Submit a Comment', 'mharty' ) . '</span>', 'title_reply_to' => esc_attr__( 'Leave a Reply to %s' ), 'comment_notes_after' => '', 'class_form' => 'clearfix', 'class_submit' => 'submit' ) ); ?>
	<?php else: ?>
