...
.mhc_widget a { color: <?php echo esc_html( get_theme_mod( 'sidebar_link_color', '#666666' ) ); ?> !important;}
...
.footer-widget a, .bottom-nav a, #footer-widgets .footer-widget li a{ color: <?php echo esc_html( get_theme_mod( 'footer_widgets_color_link', '#ffffff' ) ); ?> !important;}
