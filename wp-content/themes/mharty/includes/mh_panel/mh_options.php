	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
		   ...
		   array( "name" => esc_html__("Mharty Activation ID", "mharty"),
			   ...
			   "desc" => mh_wp_kses( __('Enter your ID here. You will find your ID in Your Profile section.', 'mharty' ) . ' <a href="https://mharty.com/member/profile" target="_blank">' . __('Click here', 'mharty' ) . '</a>'),
				 ),
...
array( "name" => "wrap-social",
		...
		array( "type" => "subnavtab-start",),
			...
			array( "name" => esc_html__("WordPress Icon", "mharty" ),
                   "id" => $themename."_show_wordpress_icon",
                   "type" => "checkbox",
                   "std" => "off",
				   "desc" => esc_html__("Here you can choose to display the Icon on your website. Add your URL in the field below.", "mharty" ),
					 ),
		...
		array( "name" => esc_html__("Mixlr URL", "mharty" ),
			...
			array( "name" => esc_html__("WordPress URL", "mharty" ),
                   "id" => $themename."_wordpress_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => esc_html__("Enter the URL of your Account.", "mharty" ),
