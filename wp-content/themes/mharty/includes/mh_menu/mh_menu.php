...
function mh_add_mobile_navigation(){
	...
	echo '<div id="mh_mobile_nav_menu">
		...
		<div id="top-header" class="<?php echo esc_attr( $secondary_nav_class . $promo_class );?>">
			...
			<?php if ( $mh_contact_info_defined ) : ?>
				...
				$date = '' !== mh_get_option( 'mharty_header_date_format') ? mh_get_option( 'mharty_header_date_format', 'd/m/Y' ): 'd/m/Y';?>
					<span class="mh-info-date mh-icon-before mh-icon-after"><?php echo date_i18n( $date, time() ); ?></span>
				<?php endif; ?>
                
				<?php if ( '' !== ( $mh_custom_phrase = get_theme_mod( 'header_phrase', '' ) ) ) : ?>
					<span class="mh-info-custom-text mh-icon-before mh-icon-after"><?php echo mh_sanitize_text_input( $mh_custom_phrase ); ?></span></a>
				<?php endif; ?>
        		...
        		<?php if ( '' !== ( $mh_email = get_theme_mod( 'header_email', '' ) ) ) : ?>
					<a class="mh-info-email-url" href="<?php echo esc_attr( 'mailto:' . $mh_email ); ?>"><span class="mh-info-email mh-icon-before mh-icon-after"><?php echo esc_html( $mh_email ); ?></span></a>
				<?php endif; ?>
		...
		<div id="top-header" class="<?php echo esc_attr( $secondary_nav_class . $promo_class );?>">
			...
			<?php if ( $mh_contact_info_defined ) : ?>
				...
				if ( true === $show_header_date ) : ?>
					<span class="mh-info-date mh-icon-before mh-icon-after"><?php echo date_i18n( mh_get_option( 'mharty_header_date_format', 'd/m/Y' ), time() ); ?></span>
				<?php endif; ?>
