...
<div id="wp-ultimo-wrap" class="wrap">
  ...
  <h2 class="nav-tab-wrapper woo-nav-tab-wrapper" style="margin: 20px 0 40px 0;">
    ...
    <a href="<?php echo network_admin_url('admin.php?page=wp-ultimo-system-info&wu-tab=').$tab_slug; ?>" class="nav-tab <?php echo (isset($_GET['wu-tab']) && $_GET['wu-tab'] == $tab_slug) ? "nav-tab-active" : ""; ?>"><?php echo $tab['title']; ?></a>
...
<?php echo str_pad(__('Active Theme', 'wp-ultimo') . ":", $pad_spaces); ?>- <?php echo $theme->get('Name') ?> - <?php echo $theme->get('Version') . ""; ?> (<?php echo $theme->get('ThemeURI'); ?>)
