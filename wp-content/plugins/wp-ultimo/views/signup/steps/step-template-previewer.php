 ...
 */
$bg_color         = WU_Util::color(WU_Settings::get_setting('top-bar-bg-color'));
$button_bg_color  = WU_Util::color(WU_Settings::get_setting('top-bar-button-bg-color'));
$button_bg_darker = WU_Util::color($button_bg_color->darken(4));

/*+
 * Get the Logo
 */
$logo_url = WU_Settings::get_setting('top-bar-use-logo') 
 ...
 * Prevent CORS
 */
document.domain = "<?php echo $current_site->domain; ?>";
...
<div id="switcher">
    <div class="center">
        ...
        <?php if (WU_Settings::get_setting('top-bar-enable-resize')) : ?>
    ...
    <ul class="links">
        <?php if (isset($_GET['cs'])) : ?>
            <li class="select-template">
                <a id="action-select" href="#"><?php echo WU_Settings::get_setting('top-bar-button-text'); ?> &rarr;</a>
            </li>
        <?php else: ?>
            <li class="select-template">
                <a id="action-select-link" href="<?php echo WU_Signup()->get_register_url( network_site_url('wp-signup.php') ) . "?template_id=$selected_template->id"; ?>"><?php echo WU_Settings::get_setting('top-bar-button-text'); ?> &rarr;</a>
            </li>
        <?php endif; ?>
    </ul>
    <?php endif; ?>

    <input type="hidden" id="template-selector" value="<?php echo $_GET['template-preview']; ?>" />
...
<div class="mobile-selector">
    <?php if (isset($_GET['cs'])) : ?>
        <a id="action-select2" href="#"><?php echo WU_Settings::get_setting('top-bar-button-text'); ?> &rarr;</a>
    <?php else: ?>
        <a id="action-select-link" href="<?php echo WU_Signup()->get_register_url( network_site_url('wp-signup.php') ) . "?template_id=$selected_template->id"; ?>"><?php echo WU_Settings::get_setting('top-bar-button-text'); ?> &rarr;</a>
    <?php endif; ?>
</div>
...
<div id="iframe" style="width: 100%;">
    <iframe src="<?php echo add_query_arg('is_wu_template_preview', '1', get_home_url($selected_template->id)); ?>" width="100%" />
</div>
