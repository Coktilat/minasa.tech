<div id="wp-ultimo-wrap" class="wrap wu-ultimo">
  ...
  <form method="post" id="mainform" action="" enctype="multipart/form-data">
    ...
    <h2 class="nav-tab-wrapper woo-nav-tab-wrapper" style="margin: 20px 0 40px 0;">
      ...
      <a href="<?php echo network_admin_url('admin.php?page=wp-ultimo&wu-tab=').$tab_slug; ?>" class="nav-tab <?php echo isset($_GET['wu-tab']) && $_GET['wu-tab'] == $tab_slug ? "nav-tab-active" : ""; ?>"><?php echo $tab['title']; ?></a>
      ...
      elseif ($field['type'] == 'note') : 
        ...
        <tr>
          ...
          <td>
            ...
            <?php $image_url = WU_Settings::get_logo('full', WU_Settings::get_setting($field_slug));
