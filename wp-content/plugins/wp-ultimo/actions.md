...
-  **apply_filters** `(line 197)` ('wu_domain_mapping_get_ip_address', $ip, $_SERVER['SERVER_ADDR']);
...
-  **apply_filters** `(line 2070)` ('wp_ultimo_redirect_url_after_signup', get_admin_url($site_id), $site_id, $user_id, $transient);
