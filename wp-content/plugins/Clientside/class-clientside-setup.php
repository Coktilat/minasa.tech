...
class Clientside_Setup {
	...
	static function action_enqueue_admin_styles() {
		...
		// Always-use CSS
		wp_enqueue_style( 'clientside-admin-css', plugins_url( 'css/clientside-admin-1.14.1.css', __FILE__ ), array(), null );
		...
		if ( Clientside::is_themed() ) {
			...
			// Theme CSS
			wp_enqueue_style( 'clientside-theme-css', plugins_url( 'css/clientside-admin-theme-1.14.1.min.css', __FILE__ ), array( 'clientside-admin-css', 'thickbox' ), null );

			// Gutenberg
			// if ( defined( 'GUTENBERG_VERSION' ) ) {
				wp_enqueue_style( 'clientside-plugin-support-css-gutenberg', plugins_url( 'css/plugin-support/clientside-gutenberg-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
			// }
			...
			if ( Clientside_Options::get_saved_option( 'enable-plugin-support' ) ) {
				...
				// Global
				wp_enqueue_style( 'clientside-plugin-support-css', plugins_url( 'css/clientside-plugin-support-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );

				// Visual Composer
				if ( defined( 'WPB_VC_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-vc', plugins_url( 'css/plugin-support/clientside-vc-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// bbPress
				if ( class_exists( 'bbPress' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-bbpress', plugins_url( 'css/plugin-support/clientside-bbpress-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Advanced Custom Fields (free + pro)
				if ( class_exists( 'acf' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-acf', plugins_url( 'css/plugin-support/clientside-acf-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// WooCommerce
				if ( class_exists( 'WooCommerce' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-woocommerce', plugins_url( 'css/plugin-support/clientside-woocommerce-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// WPML
				if ( defined( 'ICL_SITEPRESS_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-wpml', plugins_url( 'css/plugin-support/clientside-wpml-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Formidable Forms
				if ( function_exists( 'load_formidable_forms' ) ) {

					wp_enqueue_style( 'clientside-plugin-support-css-formidable', plugins_url( 'css/plugin-support/clientside-formidable-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				...
				if ( defined( 'LAYERS_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-layerswp', plugins_url( 'css/plugin-support/clientside-layerswp-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Jetpack
				if ( defined( 'JETPACK__VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-jetpack', plugins_url( 'css/plugin-support/clientside-jetpack-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Google Analytics Dashboard
				if ( defined( 'GADWP_CURRENT_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-gadash', plugins_url( 'css/plugin-support/clientside-gadash-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// HTML Editor Syntax Highlighter
				if ( defined( 'HESH_LIBS' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-htmleditorsyntax', plugins_url( 'css/plugin-support/clientside-htmleditorsyntax-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// WP Statistics
				if ( defined( 'WP_STATISTICS_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-wpstatistics', plugins_url( 'css/plugin-support/clientside-wpstatistics-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Revolution Slider
				if ( defined( 'REVSLIDER_TEXTDOMAIN' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-revslider', plugins_url( 'css/plugin-support/clientside-revslider-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Divi (builder & theme)
				if ( defined( 'ET_BUILDER_PLUGIN_VERSION' ) || function_exists( 'et_get_theme_version' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-divi', plugins_url( 'css/plugin-support/clientside-divi-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Super Forms
				if ( class_exists( 'SUPER_Forms' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-superforms', plugins_url( 'css/plugin-support/clientside-superforms-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Elementor
				if ( defined( 'ELEMENTOR_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-elementor', plugins_url( 'css/plugin-support/clientside-elementor-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Enhanced Media Library
				if ( function_exists( 'wpuxss_get_eml_slug' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-eml', plugins_url( 'css/plugin-support/clientside-eml-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// Admin Menu Tree Page View
				if ( defined( 'admin_menu_tree_page_view_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-adminmenutreepageview', plugins_url( 'css/plugin-support/clientside-adminmenutreepageview-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// W3 Total Cache
				if ( defined( 'W3TC' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-w3tc', plugins_url( 'css/plugin-support/clientside-w3tc-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// BuddyPress
				if ( class_exists( 'BuddyPress' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-buddypress', plugins_url( 'css/plugin-support/clientside-buddypress-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// WP All Import
				if ( defined( 'WP_ALL_IMPORT_PREFIX' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-wpallimport', plugins_url( 'css/plugin-support/clientside-wpallimport-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}

				// LearnDash
				if ( defined( 'LEARNDASH_VERSION' ) ) {
					wp_enqueue_style( 'clientside-plugin-support-css-learndash', plugins_url( 'css/plugin-support/clientside-learndash-1.14.1.min.css', __FILE__ ), array( 'clientside-theme-css' ), null );
				}
	...
	static function action_enqueue_admin_scripts() {
		...
		// Clientside theme JS
		wp_enqueue_script( 'clientside-admin-js', plugins_url( 'js/clientside-admin.js', __FILE__ ), $dependencies, '1.14.1' );
	...
	static function action_enqueue_login_styles() {
		...
		if ( Clientside::is_themed() ) {
			wp_enqueue_style( 'clientside-login-css', plugins_url( 'css/clientside-login-1.14.1.min.css', __FILE__ ), array(), null );
		}
	...
	static function action_enqueue_login_scripts() {
		...
		// Only if login page theming is enabled
		if ( Clientside::is_themed() ) {
			wp_enqueue_script( 'clientside-login-js', plugins_url( 'js/clientside-login.js', __FILE__ ), array( 'jquery' ), '1.14.1' );
		}
	...
	static function action_enqueue_editor_styles() {
		...
		// Load the stylesheet
		add_editor_style( plugins_url( 'css/clientside-editor-1.14.1.min.css', __FILE__ ) );
	...
	static function filter_add_body_classes( $body_classes ) {
		...
		if ( is_admin() ) {
			$all_roles = Clientside_User::get_all_roles();
