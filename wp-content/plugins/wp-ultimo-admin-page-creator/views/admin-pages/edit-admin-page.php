            ...
            <div id="wu-apc-editor-app">
              <ul class="wu-apc-content-type-selector">
                ...
                <?php foreach (WU_Admin_Pages()->get_editor_options() as $editor_type => $editor_type_info) : ?>
                  ...
                  <li v-bind:title="'<?php echo $editor_type_info['active'] ? '' : $editor_type_info['title']; ?>'" v-bind:class="(content_type == '<?php echo $editor_type; ?>' ? 'active' : '')" class="wu-tooltip <?php echo $editor_type_info['active'] ? '' : 'deactivated'; ?>">
              ...
              <div class="inside">
                ...
                <?php endforeach; ?>
                        ...
                        <div class="wpultimo-price wpultimo-price-first" style="text-align: left;" v-if="menu_type == 'menu' || menu_type == 'submenu' || menu_type == 'replace' || menu_type == 'replace_submenu'">
                          ...
                          <input placeholder="Premium Content" id="menu_label" name="menu_label" value="<?php echo $admin_page->menu_label; ?>">
                        ...
                        <div class="wpultimo-price wpultimo-price-first" style="text-align: left;" v-if="menu_type == 'menu' || menu_type == 'submenu'">
                         ...
                         <div class="wpultimo-price wpultimo-price-first" style="text-align: left;" v-show="(menu_type == 'menu' || menu_type == 'submenu' || menu_type == 'widget') ">
                          ...
                          <input placeholder="<?php _e('Optional', 'wu-apc'); ?>" id="slug_url" name="slug_url" value="<?php echo $admin_page->slug_url; ?>">
