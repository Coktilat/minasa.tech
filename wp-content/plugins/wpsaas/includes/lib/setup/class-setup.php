...
class WPSAAS_Setup {
	...
	public static function init() {
		...
		self::$vendor_dir = ABSPATH . 'wp-content/plugins/wpsaas/includes/lib/vendor';
		...
		add_action( 'plugins_loaded', array( __CLASS__, 'setup_guide' ), 999 );
	}
	...
	public static function includes() {
		...
		include_once( self::$vendor_dir . '/setup-guide/app/class-wpsaas-setup-guide.php' );
...
/** Place any new code below this line */";
	...
	public static function uct_admin_notices_screen_id( $screen_ids ) {
		return array( WPSAAS_Setup_Guide::get_screen_id() );
	}
	...
	public static function setup_guide() {
		...
		WPSAAS_Setup_Guide::init(
			array(
				'steps'          => include_once( dirname( __FILE__ ) . '/setup-guide-steps/_step-list.php' ),
				'steps_dir'      => ABSPATH . 'wp-content/plugins/wpsaas/includes/lib/setup/setup-guide-steps',
				'strings'        => array(
					// Translators: %s Theme name.
					'page-title'      => __( 'Setup %s', 'listify' ),
					'menu-title'      => __( 'WPSAAS Setup', 'listify' ),
				...
				'stylesheet_uri' => plugins_url() . '/wpsaas/includes/lib/vendor/setup-guide/app/assets/css/style.css',
			)
		);
	}
...
<p class="about-text"><?php echo wp_kses_post( __( 'Create the best SaaS product there ever was with WPSAAS! <a href="#">Checkout our website</a> for documentation and tutorials.', 'listify' ) ); ?></p>

<div class="setup-guide-theme-badge"><img src="<?=plugins_url() . '/wpsaas/assets/images/wpsaas-LOGO-1.png'?>"></div>
