...
function mh_author_page_cover_scripts() {
		$ltr = is_rtl() ? "" : "-ltr";
        wp_enqueue_style( 'mh_author_page_cover', MH_AUTHOR_PC_URL . 'assets/css/style'. $ltr .'.min.css', array(), MH_AUTHOR_PC_VER );
    }
...
// Retrieve The Post's Author ID
    ...
    $imgURL = get_mh_author_pc_meta($authorid, $size);
...
<section class="mh-author-page-cover <?php echo $styleclass; if (!'' == $imgURL ){echo ' mh-profile-img';}?>">
  ...
  <?php if (!'' == $imgURL ){ echo'style="background-image:url(' . $imgURL . ');"';}?>>
    ...
    <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID', $authorid ) ) ); ?>">
    ...
    <div class="author-header-content">
      <h1 class="author-name">
	        <?php if( get_the_author_meta('user_url', $authorid) ){
				echo '<a target="_blank" href="' . esc_url( get_the_author_meta('user_url', $authorid) ) .'">' . get_the_author_meta('display_name', $authorid) . '</a>';
			}else{
     ...
     <?php if( get_the_author_meta('twitter', $authorid) ){
				$twitter_url = get_the_author_meta('twitter', $authorid);
				if ( !preg_match('/twitter.com/', $twitter_url)) {	
					$twitter_url = 'https://twitter.com/"'. get_the_author_meta('twitter', $authorid) . '"';
				}
$au_tw = '<a href="' . esc_url( $twitter_url ) . '" class="mh-author-net twitter" title="Twitter" target="_blank"><i class="icon"></i></a>'; echo $au_tw;}?>
<?php if( get_the_author_meta('facebook', $authorid) ){
$au_fc = '<a href="' .esc_url( get_the_author_meta('facebook', $authorid) ) . '"class="mh-author-net facebook"  title="Facebook" target="_blank"><i class="icon"></i></a>'; echo $au_fc;}?>
<?php if( get_the_author_meta('googleplus', $authorid) ){
$au_gp = '<a href="' . esc_url( get_the_author_meta('googleplus', $authorid) ) . '"class="mh-author-net google-plus" title="Google+" target="_blank"><i class="icon"></i></a>'; echo $au_gp;}?>
<?php if( get_the_author_meta('youtube', $authorid) ){
$au_yt = '<a href="' . esc_url( get_the_author_meta('youtube', $authorid) ) . '"class="mh-author-net youtube" title="Youtube" target="_blank"><i class="icon"></i></a>'; echo $au_yt;}?>
<?php if( get_the_author_meta('instagram', $authorid) ){
$au_ins = '<a href="' . esc_url( get_the_author_meta('instagram', $authorid) ) . '" class="mh-author-net instagram" title="Instagram" target="_blank"><i class="icon"></i></a>'; echo $au_ins;}?>
<?php if( get_the_author_meta('snapchat', $authorid) ){
$au_sc = '<a href="' . esc_url( get_the_author_meta('snapchat', $authorid) ) . '" class="mh-author-net snapchat" title="Snapchat" target="_blank"><i class="icon"></i></a>'; echo $au_sc;}?>
<?php if( get_the_author_meta('pinterest', $authorid) ){
$au_pi = '<a href="' . esc_url( get_the_author_meta('pinterest', $authorid) ) . '" class="mh-author-net pinterest" title="Pinterest" target="_blank"><i class="icon"></i></a>'; echo $au_pi;}?>
<?php if( get_the_author_meta('dribbble', $authorid) ){
$au_dr = '<a href="' . esc_url( get_the_author_meta('dribbble', $authorid) ) . '" class="mh-author-net dribbble" title="dribbble" target="_blank"><i class="icon"></i></a>'; echo $au_dr;}?>
<?php if( get_the_author_meta('behance', $authorid) ){
$au_be = '<a href="' . esc_url( get_the_author_meta('behance', $authorid) ) . '" class="mh-author-net behance" title="behance" target="_blank"><i class="icon"></i></a>'; echo $au_be;}?>
<?php if( get_the_author_meta('linkedin', $authorid) ){
$au_ld = '<a href="' . esc_url( get_the_author_meta('linkedin', $authorid) ) . '"class="mh-author-net linkedin"  title="Linkedin" target="_blank"><i class="icon"></i></a>'; echo $au_ld;}?>
<?php if( get_the_author_meta('flickr', $authorid) ){
$au_fl = '<a href="' . esc_url( get_the_author_meta('flickr', $authorid) ) . '"class="mh-author-net flickr" title="Flickr" target="_blank"><i class="icon"></i></a>'; echo $au_fl;}?>
<?php if( get_the_author_meta('wordpress', $authorid) ){
$au_wp = '<a href="' . esc_url( get_the_author_meta('wordpress', $authorid) ) . '" class="mh-author-net wordpress" title="WordPress" target="_blank"><i class="icon"></i></a>'; echo $au_wp;}?>
        </div> <!--author-social-icons-->
        <?php } ?>
<div class="author-bio"><?php the_author_meta('description', $authorid); ?></div>
...
<div class="author-bio"><?php the_author_meta('description'); ?></div>
 ...
 <div class="author-social-icons">
	   <?php if( get_the_author_meta('twitter') ){
				...
				if ( !preg_match('/twitter.com/', $twitter_url)) {	
					$twitter_url = 'https://twitter.com/"'. get_the_author_meta('twitter') . '"';
				}
$au_tw = '<a href="' . esc_url( $twitter_url ) . '" class="mh-author-net twitter" title="Twitter" target="_blank"><i class="icon"></i></a>'; echo $au_tw;}?>
...
$au_pi = '<a href="' . esc_url( get_the_author_meta('pinterest') ) . '" class="mh-author-net pinterest" title="Pinterest" target="_blank"><i class="icon"></i></a>'; echo $au_pi;}?>
<?php if( get_the_author_meta('dribbble') ){
$au_dr = '<a href="' . esc_url( get_the_author_meta('dribbble') ) . '" class="mh-author-net dribbble" title="dribbble" target="_blank"><i class="icon"></i></a>'; echo $au_dr;}?>
<?php if( get_the_author_meta('behance') ){
$au_be = '<a href="' . esc_url( get_the_author_meta('behance') ) . '" class="mh-author-net behance" title="behance" target="_blank"><i class="icon"></i></a>'; echo $au_be;}?>
...
$au_wp = '<a href="' . esc_url( get_the_author_meta('wordpress') ) . '"class="mh-author-net wordpress" title="WordPress" target="_blank"><i class="icon"></i></a>'; echo $au_wp;}?>  
        </div> <!--author-social-icons-->
        <?php } ?>
    </div> <!-- .author-header-content --> 
  </div> <!-- .item-header -->
...
function mh_author_page_cover_body_class( $classes ) {
	if ('on' === mh_get_option( 'mharty_enable_authors_cover', 'on' )){
		$classes[] = 'mh_author_has_cover';
	}
	return $classes;
}
add_filter( 'body_class', 'mh_author_page_cover_body_class' );