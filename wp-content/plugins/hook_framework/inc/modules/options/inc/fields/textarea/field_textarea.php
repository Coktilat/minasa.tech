    ...
    if ( ! class_exists( 'ReduxFramework_textarea' ) ) {
        class ReduxFramework_textarea {
            ...
            function render() {
                ...
                ?>
                <textarea <?php echo hook_output().$readonly; ?> name="<?php echo esc_attr($this->field['name'].$this->field['name_suffix']); ?>" id="<?php echo hook_output().$this->field['id']; ?>-textarea" placeholder="<?php echo esc_attr( $this->field['placeholder'] ); ?>" class="large-text <?php echo esc_attr($this->field['class']); ?>" rows="<?php echo esc_attr($this->field['rows']); ?>"><?php echo esc_textarea( $this->value ); ?></textarea>
            <?php
            }
